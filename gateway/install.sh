...
apk add --no-cache hostapd nftables iw logrotate gettext tcpdump wget
...
for svc in hostapd nftables crond; do
...
for svc in hostapd nftables krill-tc; do
...
echo "[5/5] Installing health checks..."
